...
# google apis
GOOGLE_APIS_GMAIL_READONLY_TOKEN_PATH = os.getenv('GOOGLE_APIS_GMAIL_READONLY_TOKEN_PATH', "")
GOOGLE_APIS_GMAIL_SEND_TOKEN_PATH = os.getenv('GOOGLE_APIS_GMAIL_SEND_TOKEN_PATH', "")
GOOGLE_APIS_DRIVE_TOKEN_PATH = os.getenv('GOOGLE_APIS_DRIVE_TOKEN_PATH', "")
GOOGLE_APIS_CREDENTIALS_PATH = os.getenv('GOOGLE_APIS_CREDENTIALS_PATH', "")
...
print(f"GOOGLE_APIS_GMAIL_READONLY_TOKEN_PATH={GOOGLE_APIS_GMAIL_READONLY_TOKEN_PATH}")
print(f"GOOGLE_APIS_GMAIL_SEND_TOKEN_PATH={GOOGLE_APIS_GMAIL_SEND_TOKEN_PATH}")
print(f"GOOGLE_APIS_DRIVE_TOKEN_PATH={GOOGLE_APIS_DRIVE_TOKEN_PATH}")
print(f"GOOGLE_APIS_CREDENTIALS_PATH={GOOGLE_APIS_CREDENTIALS_PATH}")
